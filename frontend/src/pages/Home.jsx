        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose Elite Learning Academy?</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white rounded-xl shadow-lg p-8 text-center hover-lift transition-all duration-300">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 text-center hover-lift transition-all duration-300">
                ...
                <p className="text-gray-600">Apply concepts through real-world projects and case studies.</p>
              </div>
              <div className="bg-white rounded-xl shadow-lg p-8 text-center hover-lift transition-all duration-300">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 text-center hover-lift transition-all duration-300">
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-800 text-2xl font-bold mx-auto mb-6">4</div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">Career Support</h3>
                <p className="text-gray-600">Get guidance and support for your professional development.</p>
              </div>
            </div>
          </div>
        </section>
